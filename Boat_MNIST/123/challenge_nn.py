"""
TODO
- team member 1: Leonard Zieger
- team member 2: Daniele Locatelli
tasks:
...
class Net(nn.Module):
    def __init__(self):
        ...
        input_layer = nn.Linear(in_features=3 * 192 * 108, out_features=30)
        hidden_layer = nn.Linear(in_features=30, out_features=30)
        hidden_layer2 = nn.Linear(in_features=30, out_features=30)
        hidden_layer3 = nn.Linear(in_features=30, out_features=30)
        hidden_layer4 = nn.Linear(in_features=30, out_features=20)
        hidden_layer5 = nn.Linear(in_features=20, out_features=20)
        hidden_layer6 = nn.Linear(in_features=20, out_features=20)
        last_hidden_layer = nn.Linear(in_features=20, out_features=1)
...
def main():
    ...
    path_to_dataset = "dataset/" #os.path.dirname(__file__)
