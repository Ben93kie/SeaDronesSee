...
For Object Detection v2, find the [dataset](https://seadronessee.cs.uni-tuebingen.de/dataset), [visualization](OD/visualize/) and [evaluation](OD/evaluation%20of%20OD%20V2/) scripts and [training and testing tutorials](OD/OD_Tut/) here and on the [workshop page](https://seadronessee.cs.uni-tuebingen.de/wacv23).
